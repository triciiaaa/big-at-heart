...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210180758/Untitled-design-(28).png"
			...
			<div id = "formContainer">
                <form id = "userform" >
					...
					<textarea type = "name" id = "text-short" required="no" placeholder="Name"> </textarea> <br/>
						

					<label for = "email">Email: </label> <br/>
					<textarea type = "email" id = "text-short" required="no" placeholder="Email"> </textarea><br/>

					<label for = "Address">Address: </label> <br/>
					<textarea type = "add" id = "text-long" required="no" placeholder="Address"> </textarea><br/> 
					
					<label for = "Postal Code">Postal Code: </label> <br/>						
					<textarea type = "code" id = "text-short" required="no" placeholder="Code"> </textarea><br/> 

					
					<button type="button" id="addQuestionButton"><b><u>Add New Question</u></b></button> <br/>
	...
	<script src="CreateFormScript.js"></script> 
</body> 
  )
}
