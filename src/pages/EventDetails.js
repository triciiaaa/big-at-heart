  ...
  return (
    ...
    <div class="event-container">
      ...
      <div class="event-description">
        ...
        <p>
          Walk the lush green, scenic, serene Pipeline Trail that runs on top of
          the pipes that brings in water from Malaysia to Singapore. Bring your
          family and friends along on this meaningful walk for charity. The
          raised funds will be used for providing necessities to Migrant Workers
          on Labour Day under the guidance of Ministry of Manpower.
        </p>
      </div>
    </div>
