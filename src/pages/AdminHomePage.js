...
"https://static.thenounproject.com/png/4869734-200.png"
					...
					<div class="nav-option option4"> 
						<img src= 
"https://t3.ftcdn.net/jpg/05/54/60/68/360_F_554606861_txKoTSp8aBaO8oARngeSbgNcSB1yWTRc.jpg"
							class="nav-img"
							alt="calendar"/> 
...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210183320/5.png"
							class="nav-img"
							alt="report"/> 
						<h3><a href="Report.html"> Report</a></h3> 
					</div>
			...
			<div class="report-container"> 
				...
				<div class="report-body"> 
					<div class="report-topic-heading"> 
						<h3 class="t-op">Project</h3> 
						<h3 class="t-op">Start Date</h3> 
						<h3 class="t-op">End Date</h3> 
						<h3 class="t-op">Assignee</h3> 
						<h3 class="t-op">Status</h3> 
					</div> 

					<div class="items"> 
						<div class="item1"> 
							<h3 class="t-op-nextlvl">CNY Celebration 2024</h3> 
							<h3 class="t-op-nextlvl">20 Jan 2024</h3> 
							<h3 class="t-op-nextlvl">24 Feb 2024</h3> 
							<h3 class="t-op-nextlvl">Helen Heng</h3> 
							<h3 class="t-op-nextlvl label-tag-ongoing">Ongoing</h3> 
						</div> 

						<div class="item1"> 
							<h3 class="t-op-nextlvl">Christmas 2023</h3> 
							<h3 class="t-op-nextlvl">20 Dec 2023</h3> 
							<h3 class="t-op-nextlvl">30 Dec 2023</h3> 
							<h3 class="t-op-nextlvl">Meiyi Wong</h3> 
							<h3 class="t-op-nextlvl label-tag">Completed</h3> 
						</div> 

						<div class="item1"> 
							<h3 class="t-op-nextlvl">Sponsor A Meal</h3> 
							<h3 class="t-op-nextlvl">20 Nov 2023</h3> 
							<h3 class="t-op-nextlvl">20 Nov 2023</h3> 
							<h3 class="t-op-nextlvl">Sally Sim</h3>
							<h3 class="t-op-nextlvl label-tag-ongoing">Ongoing</h3> 
						</div> 

						<div class="item1"> 
							<h3 class="t-op-nextlvl">Frontliner Appreciation</h3> 
							<h3 class="t-op-nextlvl">21 Sep 2023</h3> 
							<h3 class="t-op-nextlvl">21 Sep 2023</h3> 
							<h3 class="t-op-nextlvl">Helen Heng</h3>
							<h3 class="t-op-nextlvl label-tag">Completed</h3> 
						</div> 
						...
						<div class="item1"> 
							<h3 class="t-op-nextlvl">National Day</h3> 
							<h3 class="t-op-nextlvl">8 Aug 2023</h3> 
							<h3 class="t-op-nextlvl">8 Aug 2023</h3> 
							<h3 class="t-op-nextlvl">Lee Hui Ting</h3>
							<h3 class="t-op-nextlvl label-tag">Completed</h3> 
						</div> 

						<div class="item1"> 
							<h3 class="t-op-nextlvl">Frontliner Appreciation</h3> 
							<h3 class="t-op-nextlvl">21 Jun 2023</h3> 
							<h3 class="t-op-nextlvl">21 Jun 2023</h3> 
							<h3 class="t-op-nextlvl">Helen Heng</h3>
							<h3 class="t-op-nextlvl label-tag-cancelled">Cancelled</h3> 
						</div> 

						<div class="item1"> 
							<h3 class="t-op-nextlvl">Labour Day 2023</h3> 
							<h3 class="t-op-nextlvl">22 Apr 2023</h3> 
							<h3 class="t-op-nextlvl">22 Apr 2023</h3> 
							<h3 class="t-op-nextlvl">Tricia Tan</h3> 
							<h3 class="t-op-nextlvl label-tag">Completed</h3> 
						</div> 
					</div> 
				</div>
